...
<a href="<?php echo url_for('job/new') ?>" class="btn btn-light">New</a>
<div class="row">
<div class="col-md-8">
<table class="table">
  <thead>
  ...
  <tbody>
    ...
    <tr>
      <td scope="row"><a href="<?php echo url_for('job/show?id='.$jobeet_job->getId()) ?>"><?php echo $jobeet_job->getId() ?></a></td>
